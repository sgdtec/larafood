                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td style="width=10px;">
                                ...
                                <a href="{{ route('roles.show', $role->id) }}" class="btn btn-warning btn-sm">VER</a>
                                <a href="{{ route('roles.permissions', $role->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-lock"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
